...
|----images            # Given to the team (Definition of the project)   
        |----appicon.png   
        |----gfavicon.png
...
Build a Landing that is functionally similar to this: [Google Landing Page](https://www.google.com/)
...
### With this project, team members;
